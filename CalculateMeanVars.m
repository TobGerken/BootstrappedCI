...
%function funOut = CalculateBootstrap(cs, amod, cat, nboot)
warning('off','all')
        ...
        for mod = AtmosMod
            for Level = Levels
                ...
                for sample =  1:nboot+1 
                    ...
                    toc
                    timeElapsed = tic;
                    save([OutDir 'VarOutput_' mod{1} '_' Nme.(c{1}){nm} '_' Level{1} '.mat'], 'Distance', 'Gamma', 'Gamma_pred', 'Coefs', 'model_data', 'G_sigma', 'N_tot', 'b','boots', 'timeElapsed')
